...
CONSENT_RATE = 0.95          # 92% of customers consent
...
# Introduce a small number of duplicates
for _ in range(DUPLICATE_ROWS):
    accelerometer.append(accelerometer[0])
# Force at least 2 deterministic outliers
...
print("Tuned synthetic dataset generated (high survival rate).")